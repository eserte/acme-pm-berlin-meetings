*** TODO all Berlin.pm meetings
    ...
    Siehe auch ~/src/bbbike-aux/misc/pmmeetings2bbd.pl für einen
    Konverter.

    Für Acme-PM-Berlin-Meetings konvertieren:
    : ~/bin/pistachio-perl/bin/perl ~/src/bbbike-aux/misc/pmmeetings2bbd.pl | ~/src/bbbike/miscsrc/bbd2kml -title "Berlin PM meetings" - >| ~/src/CPAN/Acme-PM-Berlin-Meetings/data/berlin-pm.kml; cd ~/src/CPAN/Acme-PM-Berlin-Meetings/data && git diff berlin-pm.kml  
    : ~/bin/pistachio-perl/bin/perl ~/src/bbbike-aux/misc/pmmeetings2bbd.pl | ~/src/bbbike/miscsrc/bbd2geojson - >| ~/src/CPAN/Acme-PM-Berlin-Meetings/data/berlin-pm.geojson; cd ~/src/CPAN/Acme-PM-Berlin-Meetings/data && git diff berlin-pm.geojson
    : git diff
    : git commit -m "kml and geojson update" berlin-pm.* && git push

    Und für die Karte auf berlin.pm.org:
    : ~/bin/pistachio-perl/bin/perl ~/src/bbbike-aux/misc/pmmeetings2bbd.pl -r | ~/src/bbbike/miscsrc/bbd2geojson -bbbgeojsonp - >| ~/work2/BerlinPM.github.io/javascripts/berlin-pm.geojsonp
    : cd ~/work2/BerlinPM.github.io/javascripts
    : git diff
    : git commit -m "update historical map" berlin-pm.geojsonp && git push
